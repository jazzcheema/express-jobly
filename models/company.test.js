...
describe("findAll", function () {
  ...
  test("works: filters by minEmployee", async function () {
  ...
  test("works: filters by MaxEmployee", async function () {
  ...
  test("works: filters by name, min, and maxEmployees", async function () {
    let companies = await Company.findAll({
      nameLike: "C",
      minEmployees: "2",
      maxEmployees: "4"
  ...
  test("Should throw error: min > maxEmployee", async function () {
    try {
      let companies = await Company.findAll({
        minEmployees: "2",
        maxEmployees: "1"
